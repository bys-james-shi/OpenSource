...
namespace Aliyun.OpenServices
{
    ...
    public class ClientConfiguration : ICloneable
    {
        ...
        private const string DefaultRootDomains = "aliyuncs.com,aliyun-inc.com,aliyun.com,localhost";
        private readonly IList<string> _rootDomains = new List<string>();
        ...
        public IList<string> RootDomainList
        {
            get
            {
                ...
                {
                    var domains = DefaultRootDomains.Split(',');
